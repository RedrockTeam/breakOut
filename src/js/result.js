$(document).ready(() => {
    ...
    * */
    ...
    function returnTitle (sco) {
        let text = ['冲破四道封锁线', '强渡乌江', '遵义会议', '四渡赤水', '巧渡金沙江', '强渡大渡河、飞夺泸定桥', '爬雪山、过草地', '突破腊子口'];
        return text[sco];
    }
    ...
    function returnStory (sco) {
        let text = [
            ...
            '1935年1月1日，中共中央在瓮安猴场作出重要决定：“建立川黔边新苏区根据地。首先以遵义为中心的黔北地区，然后向川南发展，是目前最中心的任务。” 距离瓮安县城45公里的乌江江界河渡口是通往遵义的主要渡口，中央红军立即作出强渡乌江战斗的决定。1935年1月1日，毛泽东、朱德、周恩来等率领中央红军，经过3天3夜的顽强战斗，强渡乌江，击败黔军，向遵义挺进。',
            ...
            '四渡赤水战役，中央红军在长征途中，进行的一次决定性运动战战役。一渡赤水，作势北渡长江却回师黔北；二渡赤水，红军回师向东，利用敌人判断红军将要北渡长江的错觉，5天之内，取桐梓、夺娄山关、重占遵义城；三渡赤水，再入川南，待蒋介石向川南调集重兵之时，红军已从敌军间隙穿过；四渡赤水，南渡乌江，兵锋直指贵阳，趁坐镇贵阳的蒋介石急调滇军入黔之际，红军又入云南……1960年，当来访的二战名将蒙哥马利赞誉毛泽东指挥的解放战争三大战役时，毛泽东说，四渡赤水才是他自己的得意之笔。',
            ...
            '在长征中，红一方面军先后翻越了夹金山、梦笔山等5座海拔4000米以上的雪山。红二方面军先后翻越了哈巴雪山(玉龙雪山)、大、小雪山、扎拉亚卡山等二十多座雪山。红四方面军是最早踏入雪山地区的部队，由于曾三次跋涉雪山草地，在雪线以上区域停留时间最长，累计翻越雪山超过20次。 红军过的草地属于高原湿地，为泥质沼泽。位于青藏高原与四川盆地的过渡地带，主要是指川西北若尔盖地区。 纵长500余里，横宽300余里，面积约15200平方公里，海拔在3500米以上。每年的5月至9月为草地雨季，使本已滞水泥泞的沼泽，更成漫漫泽国。红军正是在这个季节经过草地的。',
            '腊子口，是中央红军长征路上跨越的最后天险，周围群山耸立，峡道宽仅8米。腊子河从峡口奔涌而出，只有一座1米多宽的木桥可通行。山后，敌人3个团纵深部署，企图堵死红军北上之路。1935年9 月中国工农红军进入腊子口地区，通过正面强攻与攀登悬崖峭壁迂回包抄的战术，经过浴血奋战，一举攻破了鲁大昌部和邓秀廷部据险扼守的天险腊子口天险，打开了中央红军北上进入陕甘的通道。聂荣臻元帅曾对此评论说：“腊子口一战，北上的通道打开了。如果腊子口打不开，无论军事上、政治上，都会处于进退失据的境地。'
        ];
        return text[sco];
    }
    /*
     ...
     *   然后的话问一下 通关之后显示的内容是显示最后一关的内容还是另外显示
     * */
